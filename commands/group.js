...
cmd({
        ...
        async(Void, citel, text) => {
            if (!citel.quoted) return citel.reply(`${tlang().hwmksti}`);
            let mime = citel.quoted.mtype
            pack = Config.packname
            author = Config.author
            if (citel.quoted) {
                let media = await citel.quoted.download();
                citel.reply("*🔄⏳ Please Wait. I'm Creating Your Sticker ⌛🔜*");
                ...
                if ((quoted.msg || citel.quoted)
                    .seconds > 20) return citel.reply("${tlang().stkvidsec}");
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            memek = await Void.sendImageAsSticker(citel.chat, meme, citel, { packname: citel.pushName, author: 'Dragon' })
