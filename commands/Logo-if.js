...
cmd({ pattern: "deepsea", alias: ["logo1"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
        ...
        Void.sendMessage(citel.chat, { image: { url: anu }, caption: `⦿ .*🧮 𝙼𝙰𝙳𝙴 𝙱𝚈 :-* *_𝙳𝚁𝙰𝙶𝙾𝙽-𝙼𝙳  🪄_*` }, { quoted: citel })

    })

    //---------------------------------------------------------------------------

cmd({ pattern: "horror", alias: ["logo2"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "whitebear", alias: ["logo3"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "joker", alias: ["logo4"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "metallic", alias: ["logo5"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "steel", alias: ["logo6"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "harrypotter", alias: ["logo7"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "underwater", alias: ["logo8"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({ pattern: "luxury", alias: ["logo9"], category: "textpro", react: "🎡", desc: "Some text to image feature with various styles." }, async(Void, citel, text) => {
...
cmd({
       ...
       Void.sendMessage(citel.chat, {
                ...
                image: {
                    ...
                    url: `https://saipulanuar.ga/api/maker/joker?text=${text}` ,
...
cmd({
       ...
       Void.sendMessage(citel.chat, {
                ...
                image: {
                    ...
                    url: `https://saipulanuar.ga/api/maker/pubeje?apikey=APIKEY&text=FREE%20FIRE%20PLAYER&text2=${text}` ,
